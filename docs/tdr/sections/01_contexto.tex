...
La solución combina optimización matemática, teoría de grafos y aprendizaje por refuerzo multiagente. Como referencias determinísticas se utilizan Greedy y MILP; como extensión adaptativa se incorpora una política MARL cooperativa con parámetros compartidos. Todo el análisis espacial parte de \texttt{MapProbabilidad\_adulto.csv}; no se sustituye la superficie por un mapa sintético.
