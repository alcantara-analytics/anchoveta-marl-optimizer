...
\subsection{MARL}
Se implementa una política cooperativa basada en PPO con parámetros compartidos. Durante el entrenamiento se generan escenarios simulados mediante perturbación gaussiana del mapa real, con $\sigma=0.04$. La perturbación es una simulación explícita para entrenamiento, no un dato observado.
